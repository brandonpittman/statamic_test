...
return [
    ...
    'view_site' => 'サイトを見る',
    'visit_url' => 'サイトを見る',
    'search_for_anything' => '何でもを検索',

    // Pages
    'page' => 'ページ',
    'pages' => 'ページ|ページ',
    'nav_pages' => 'ページ',
    'create_page_button' => '新ページ',
    'edit_homepage_button' => 'ホームページを編集',
    'create_page' => '新ページ',
    'page_created' => 'ページが作成された',
    'editing_page' => 'ページを編集中',
    'page_updated' => 'ページが更新された',
    'home' => 'ホーム',
    'show_urls' => 'アドレスを見せる',
    'show_titles' => 'タイトルを見せる',
    'choose_page_type' => 'ページタイプを変える',
    'parent_page' => '親のページ',
    'pages_reordered' => 'ページの順番が変更された。',

    // Collections
    'collections' => 'コレクション|コレクション',
    'nav_collections' => 'コレクション',
    'manage_collections' => 'コレクションを管理する',
    'create_collection_button' => '新コレクション',
    'create_collection' => '新コレクション',
    'collection_created' => ':title 作成された',
    'editing_collection' => ':collection　編集中',
    'collection_updated' => ':title 更新された',
